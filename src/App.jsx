...
function App() {
  return (
    // Main container using flexbox to center the content vertically and horizontally
    <main className="min-h-screen bg-gray-100 flex justify-center items-center p-4 font-sans">
      {/* Card container with a max-width */}
      <div className="w-full max-w-sm">

        {/* Logo Section */}
        <div className="flex justify-center items-baseline font-poppins tracking-wider text-teal-600 text-4xl">
        ...
        <div className="mt-12">
          <form action="#" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="mb-4">
              ...
              <input
                type="email"
                className="py-3 px-4 text-sm rounded-md w-full bg-white border border-gray-300 text-gray-900 focus:outline-none focus:ring-2 focus:ring-teal-500"
        ...
        <div className="my-8 flex items-center">
          ...
          <span className="flex-shrink mx-4 text-gray-400 text-xs">or sign in with</span>
          <div className="flex-grow border-t border-gray-300"></div>
        </div>
